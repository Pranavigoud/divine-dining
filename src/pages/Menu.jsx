...
const Menu = () => {
  return (
    <div className="bg-[#FAF7F4] min-h-screen flex flex-col items-center px-6 py-10 font-poppins relative">
      <img src={Group4} alt="decoration" className='absolute z-0 bottom-5 left-0 opacity-20 grayscale' />
      <img src={Group4} alt="decoration" className='absolute z-0 bottom-1/2 right-0 opacity-20 grayscale ' />
      <img src={Group3} alt="decoration" className='absolute z-0 top-0 left-0' />
      <img src={Group2} alt="decoration" className='absolute z-0 right-0 bottom-0 ' />
      {/* Title */}
      ...
      <div className="w-full max-w-3xl border-t border-[#1E2C45] py-8 text-center">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-lg">Beef $12 | Chicken $14 | Fish or Shrimp $16</p>
          </div>
          <div>
            <p className="font-normal text-lg">Yellow Rice</p>
            <p className="text-lg">Chicken $15 | Shrimp $17 | Combo $20</p>
            <p className=" text-base">
