    ...
    <div>
      <div className="bg-[#FAF7F4] min-h-screen flex flex-col items-center px-6 py-10 font-poppins relative overflow-hidden">
        ...
        <img
          src={Group4}
          alt="decoration"
          className="pointer-events-none select-none absolute z-0 opacity-20 grayscale
            max-w-[80px] bottom-5 left-2
            sm:max-w-none sm:bottom-5 sm:left-0"
        />
        <img
          src={Group4}
          alt="decoration"
          className="pointer-events-none select-none absolute z-0 opacity-20 grayscale
            max-w-[80px] bottom-1/2 right-2
            sm:max-w-none sm:bottom-1/2 sm:right-0"
        />
        <img
          src={Group3}
          alt="decoration"
          className="pointer-events-none select-none absolute z-0
            max-w-[80px] top-0 left-2
            sm:max-w-none sm:top-0 sm:left-0"
        />
        <img
          src={Group2}
          alt="decoration"
          className="pointer-events-none select-none absolute z-0
            max-w-[80px] right-2 bottom-2
            sm:max-w-none sm:right-0 sm:bottom-0"
        />

        {/* Title */}
        <h1 className="text-4xl sm:text-5xl font-playfair text-[#1E2C45] mb-8">
          Our Menu
        </h1>

        {/* Starters */}
        <div className="w-full max-w-3xl border-t border-[#1E2C45] py-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6">Starters</h2>
          <div className="space-y-6">
            <div>
              <p className="text-lg font-medium">WINGS</p>
        ...
        {/* Mains */}
        <div className="w-full max-w-3xl border-t border-[#1E2C45] py-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6">Mains</h2>
          <div className="space-y-6">
            <div>
        ...
        {/* Drinks */}
        <div className="w-full max-w-3xl border-t border-[#1E2C45] py-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6">Drinks</h2>
          <div className="space-y-6">
            <div>
