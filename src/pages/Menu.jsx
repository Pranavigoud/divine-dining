...
const Menu = () => {
  return (
    <div className="bg-[#FAF7F4] min-h-screen flex flex-col items-center px-6 py-10 font-poppins relative">
      <img src={Group4} alt="" className='absolute bottom-5 left-0 opacity-20 grayscale ' />
      <img src={Group4} alt="" className='absolute bottom-1/2 right-0 opacity-20 grayscale ' />
      <img src={Group3} alt="" className='absolute top-0 left-0' />
      <img src={Group2} alt="" className='absolute right-0 bottom-0 ' />
      {/* Title */}
